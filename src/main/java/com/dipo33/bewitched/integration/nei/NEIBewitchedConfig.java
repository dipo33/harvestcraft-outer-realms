...
public class NEIBewitchedConfig implements IConfigureNEI {
    ...
    /**
     * Prevents Bewitched crop blocks from appearing in NotEnoughItems and registers NEI handlers for mutation recipes and usages.
     *
     * This hides the mod's crop blocks from NEI item lists and registers MutationNEIHandler as both a recipe handler and a usage handler.
     */
    @Override
