...
public class BlockRegistry {
    ...
    public static final ObjectHolder<Block> BELLADONNA_CROP = new ObjectHolder<>(
        () -> new BwBlockCrops(ItemRegistry.BELLADONNA_SEED, ItemRegistry.BELLADONNA_FLOWER).setStages(5));
    public static final ObjectHolder<Block> WOLFSBANE_CROP = new ObjectHolder<>(
        () -> new BwBlockCrops(ItemRegistry.WOLFSBANE_SEED, ItemRegistry.WOLFSBANE_FLOWER).setStages(8));
    public static final ObjectHolder<Block> WATER_ARTICHOKE_CROP = new ObjectHolder<>(
        () -> new BwBlockCrops(ItemRegistry.WATER_ARTICHOKE_SEED, ItemRegistry.WATER_ARTICHOKE_GLOBE).setStages(5)
            .setPlantType(EnumPlantType.Water));
    public static final ObjectHolder<Block> MANDRAKE_CROP = new ObjectHolder<>(
        () -> new BwBlockCrops(ItemRegistry.MANDRAKE_SEED, ItemRegistry.MANDRAKE_ROOT).setStages(5));
    public static final ObjectHolder<Block> SNOW_WISP_CROP = new ObjectHolder<>(
        () -> new BwBlockCrops(ItemRegistry.SNOW_WISP_SEED, new ObjectHolder<>(() -> Items.snowball)).setStages(5)
            .addAdditionalDrops(ItemRegistry.ICY_NEEDLE, 0.1D));
    public static final ObjectHolder<Block> GARLIC_CROP = new ObjectHolder<>(
        () -> new BwBlockCrops(ItemRegistry.GARLIC, ItemRegistry.GARLIC).setStages(6));
